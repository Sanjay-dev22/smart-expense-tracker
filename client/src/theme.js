...
export const getTheme = (mode = 'light') => {
  ...
  return createTheme({
    ...
    typography: {
      ...
      h1: { fontWeight: 800, letterSpacing: 0, fontSize: '2.5rem', lineHeight: 1.1 },
      h2: { fontWeight: 800, letterSpacing: 0, fontSize: '2rem', lineHeight: 1.18 },
      h3: { fontWeight: 800, letterSpacing: 0, fontSize: '1.5rem', lineHeight: 1.22 },
      h4: { fontWeight: 800, letterSpacing: 0, fontSize: '1.25rem', lineHeight: 1.25 },
